...
// Mirror of gateway's JwtAuthGuard. Same chain:
//   header → signature → tenantId/sub claims → registry resolves →
//   tenant.status === 'active' → CLS populated → route handler runs.
// Extracted to shared lib in milestone 1.6 alongside Keycloak swap.
